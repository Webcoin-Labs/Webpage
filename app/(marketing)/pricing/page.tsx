...
const tiers = [
  ...
  },
  {
    name: "Growth",
    price: "$149/mo",
    subtitle: "Ship and scale faster",
    features: [
      "AI pitch deck analysis workflow",
      "Priority founder-builder matching",
      "Hiring and applications visibility",
      "Launch and GTM strategy sessions",
    ],
